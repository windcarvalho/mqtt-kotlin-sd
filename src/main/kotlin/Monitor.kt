...
fun main() = application {
    Window(
        ...
        title = "Monitor de Temperatura MQTT") 
        {
        MonitorApp()        
    }
}
...
fun MonitorApp() {
    ...
    fun subscribeMQTT() {        
        ...
        client.subscribe("lab04/temperatura") { subscribedTopic, message ->
            ...
            temperatures = temperatures.toMutableList().apply {
                ...
                if (partes.size == 2) {
                    ...
                    this[0] = Temperature(partes[0].take(6), partes[1].take(10)) // Atualiza a temperatura e o nome do cliente na posição indexMedida
